  ...
  <div className="w-full min-h-screen pb-24" style={{ fontFamily: 'Nunito, sans-serif', backgroundColor: '#FFE8C8' }}>
    <div className="p-4" style={{ 
      ...
      <div className="relative flex flex-col rounded-3xl overflow-hidden" style={{ 
        ...
        <div className="relative flex-1 overflow-hidden" style={{ height: 'calc(50vh - 140px)' }}>
                     <img 
        ...
        <div className="px-6 py-4 flex flex-col justify-center" style={{ height: '140px' }}>
          <p className="text-sm text-white/90 text-center mb-4" style={{ fontFamily: 'Open Sans, sans-serif' }}>
