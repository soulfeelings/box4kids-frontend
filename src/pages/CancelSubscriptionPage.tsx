...
export const CancelSubscriptionPage: React.FC<CancelSubscriptionPageProps> = ({ onCancel, onConfirm }) => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Header */}
      <div className="bg-white shadow-sm p-4 flex justify-between items-center">
        <h1 className="text-xl font-bold text-gray-800">Остановить подписку?</h1>
        <button 
          onClick={onCancel}
      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-32">
        <div className="max-w-md w-full text-center">
          <div className="bg-white rounded-3xl p-8 shadow-lg">
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Остановить подписку?</h2>
              <p className="text-gray-600 leading-relaxed">
                Мы приостановим доставку коробок<br />
                и подбор игрушек. Вы сможете возобновить<br />
