          ...
          <div className="flex flex-col gap-6" style={{ fontFamily: 'Nunito, sans-serif' }}>
            ...
            <div className="bg-orange-100 rounded-lg p-4 border border-orange-200">
              <p className="text-sm font-medium text-orange-800 text-center">
                После изменения номера телефона изменится номер для входа в сервис.
              </p>
            </div>
            ...
            <div className="text-center">
              <p className="text-base font-medium text-gray-700">
                Мы отправим код подтверждения на ваш текущий номер {currentPhone}
              </p>
            </div>
          ...
          <div className="flex flex-col gap-6" style={{ fontFamily: 'Nunito, sans-serif' }}>
            ...
            <div className="flex flex-col gap-1">
              <div className={`w-full border-2 rounded-2xl px-3 py-3 bg-gray-50 focus-within:ring-0 transition-all ${
                error 
                  ? 'border-red-400' 
                  : currentCode ? 'border-[#7782F5]' : 'border-gray-200 focus-within:border-[#7782F5]'
              }`}>
                <input
                  type="text"
            ...
            <div className="text-center">
              {resendTimer > 0 ? (
                <p className="text-sm text-gray-500">
                  Получить новый код через {resendTimer} секунд{resendTimer === 1 ? 'у' : resendTimer < 5 ? 'ы' : ''}
                </p>
              ) : (
                <button 
      ...
      case Step.NewPhoneInput:
        ...
        return (
          <div className="flex flex-col gap-6" style={{ fontFamily: 'Nunito, sans-serif' }}>
            ...
            <div className="flex flex-col gap-1">
              <div className={`w-full border-2 rounded-2xl px-3 py-3 bg-gray-50 focus-within:ring-0 transition-all ${
                newPhone ? 'border-[#7782F5]' : 'border-gray-200 focus-within:border-[#7782F5]'
              }`}>
                <input
                  type="tel"
          ...
          <div className="flex flex-col gap-6" style={{ fontFamily: 'Nunito, sans-serif' }}>
            ...
            <div className="flex flex-col gap-1">
              <div className={`w-full border-2 rounded-2xl px-3 py-3 bg-gray-50 focus-within:ring-0 transition-all ${
                error 
                  ? 'border-red-400' 
                  : newCode ? 'border-[#7782F5]' : 'border-gray-200 focus-within:border-[#7782F5]'
              }`}>
                <input
                  type="text"
                  className="w-full text-base font-medium bg-transparent border-0 outline-none focus:ring-0 text-center tracking-widest"
    ...
    <div className="min-h-screen bg-[#FFFFFF] pb-20" style={{ fontFamily: 'Nunito, sans-serif' }}>
      ...
      <div className="px-4 py-6">
        <div className="flex items-center justify-center relative">
          <h1 className="text-[20px] font-semibold text-gray-900 text-center">Изменить номер</h1>
          <button 
            onClick={onClose}
